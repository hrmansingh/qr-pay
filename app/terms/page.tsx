      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="prose prose-gray max-w-none space-y-6 text-gray-700 leading-relaxed">
            <p>
              For the purpose of these Terms and Conditions, The term "we", "us", "our" used anywhere on this page shall mean <strong>MOHIT</strong>, whose registered/operational office is #267 vasant vihar pahe-2 dhakoli zirakpur Mohali PUNJAB 160104. "you", "your", "user", "visitor" shall mean any natural or legal person who is visiting our website and/or agreed to purchase from us.
            </p>
            ...
            <ul className="list-disc pl-6 space-y-3">
              ...
              <li>
                You may not create a link to our website from another website or document without MOHIT's prior written consent.
              </li>
